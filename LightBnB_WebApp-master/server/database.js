...
console.log("addPorpertySQLQuery, propertyDetails = ", addPorpertySQLQuery, propertyDetails)
return pool.query(addPorpertySQLQuery, propertyDetails)
  .then (res => res.rows);
}
